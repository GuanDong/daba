...
//        renderText("Ok");
    ...
    public static Map<String, String> getJSSDKPayInfo(String ip, OrderM order) throws WxErrorException {
        ...
        params.put("total_fee", order.price.toString());
        params.put("spbill_create_ip", ip);
        params.put("time_start", order.createdDate.toString());
        params.put("time_expire", order.price.toString());
        params.put("notify_url", order.price.toString());
